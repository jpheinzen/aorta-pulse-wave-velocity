...
% method 2 - I recommend using 4 or 5
subMethodNum = 4;
...
% 3 is like 8/10, but lets MATAB choose a window
switch methodNum
    case 1
    ...
    case 3
        % like 8/10, but lets MATAB choose a window
        delay = findDelay3(quantity,lineNum,timeVal,fps,npinterpH,debug,smoothMethod);
    case 4
...
% NOTE: This method currently assumed 60bpm, but could be easily changed by
% adding another variable
function delay = findDelay3(quantity,lineNum,timeVal,fps,npinterpH,debug,smoothMethod)
% NOTE: This method currently assumed 60bpm, but could be easily changed by
% adding another variable
% WARNING: DO NOT RUN DEBUG MODE IN A LOOP

% smooth the quantity
sQuantity = smoothdata(quantity,smoothMethod);
...
% smooth the quantity
sQuantity = smoothdata(quantity,smoothMethod,smoothRange);
...
% smooth the quantity
sQuantity = smoothdata(quantity,smoothMethod,smoothRange);
sQuantity = smoothdata(sQuantity,smoothMethod,smoothRange);
