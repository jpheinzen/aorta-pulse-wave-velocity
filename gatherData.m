...
fps = 1200; 
wt = [2,1.5,1.25]; 
lineLength = 70;        % Length of lines across region
...
% (You need to end up in folder with .tif files)
cd(folderName)
%% Video Initialization
[mov,vidName, numFrames, type, maxCVal, height, width] = vidInit();
...
%% skeletonization
[skeleim, endpts] = findSkeleton(Lim3, minBL,1.1);
